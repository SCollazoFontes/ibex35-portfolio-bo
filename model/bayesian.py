...
class ParadaSinMejora:
    """Criterio de parada: detiene la optimización si no hay mejora suficiente."""
...
def modelo_OB(rendimientos_diarios_periodo, risk_free_rate, params=None):
    ...
    return pesos_tickers, -resultado.fun, rendimiento_ex_ante, resultado.func_vals


def OB(año_inicio, años_atras, año_final, data, params=None):
